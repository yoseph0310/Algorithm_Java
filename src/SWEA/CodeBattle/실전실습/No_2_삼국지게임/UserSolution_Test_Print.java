...
//        System.out.println("ally("+monarchA+", "+monarchB+")");
//        System.out.println("  " + monarchA + " 's hashCode() : " + monarchA.hashCode());
//        System.out.println("  " + monarchB + " 's hashCode() : " + monarchB.hashCode());
...
//        System.out.println("attack("+monarchA+", "+monarchB+", "+general+")");
...
//        System.out.println("  " + idxB + " " + find(idxB));
//        System.out.println("  " + unionList[idxB].size());
//        System.out.println("  " + (Integer) idxB);
        // 방어 실패 - 공격 대상지는 삭제된다.
...
//        System.out.println("recruit("+monarch+", "+mNum+", "+mOption+")");
...
//        System.out.println("  " + recruitCnt);
    ...
    static void printMonarchHM() {
        System.out.println("** 현재 군주 정보 **");
        for (String key: monarchHM.keySet()) {
            System.out.println("  " + key + " 보유 병력 : " + nationInfoList[monarchHM.get(key)].soldierNum );
        }

        System.out.println("** monarchHM.size() : " + monarchHM.size());
        System.out.println();
    }
}