...
class UserSolution_Test_Print {
    ...
    static class Channel {
        ...
        // 한 채널을 모든 유저가 구독할 수 있으므로 MAX_USER_SIZE
        public Channel() {
    ...
    static News[] newsPool;         // 최대 뉴스 개수 : 4,000,000
...
//            System.out.println("  " + mTime + " 시에 해당하는 알림을 유저들에게 전송합니다.");
            News cur = newsPQ.peek();

            if (cur.alarmTime > mTime) {
//                System.out.println("  뉴스 알람 시간이 아닙니다. (현재시각) : " + mTime + "  (알람시각) : " + cur.alarmTime);
                return;
            }
//            System.out.println("  뉴스 알람 시간입니다. (현재시각) : " + cur.alarmTime);

            newsPQ.poll();

            if (!cur.isValid) {
//                System.out.println("  삭제된 뉴스입니다.");
                continue;
            }

//            System.out.println("  유저풀에 추가");
...
//        System.out.println(++Order + " registerUser()");
...
//        System.out.println(++Order + " offerNews()");
        // mTime 시각에 mDelay 시간이 있는 mNewsID (News 객체) 를
        // newsID 인덱싱 처리
...
//        System.out.println("  뉴스 PQ에 저장된 뉴스 정보 : ");
//        System.out.println("  news alarmTime : " + newsPool[newsIdx].alarmTime);
//        System.out.println("  news newsID : " + newsPool[newsIdx].newsID);
//        System.out.println("  news channelID : " + newsPool[newsIdx].channelID);
//        System.out.println("  news isValid : " + newsPool[newsIdx].isValid);
//        System.out.println("  뉴스 우선순위큐 사이즈 : " + newsPQ.size());

        // 해당 채널의 유저 수 반환
//        System.out.println("  userCnt : " + channelsPool[channelIdx].userIdxList.size());
...
//        System.out.println(++Order + " cancelNews()");
...
//        System.out.println(++Order + " checkUser()");
...
//        System.out.println("  newsCnt : " + newsCnt);
        int cnt = 0;
