...
//        System.out.println("  " + node.name +" 의 부모 노드 상태 ");
        for (int i = 1; i < MAX_PARENT_LENGTH; i++) {
            if (node.parent[i - 1].name == null) break;
            else {
                node.parent[i] = node.parent[i - 1].parent[i - 1];
//                System.out.println("    n.parent : " + node.parent[i-1].name);
            }
...
//        System.out.println("  " + node1.name + " 와 " + node2.name + " 의 거리 반환 ");
//        System.out.println("  node1.depth : " + node1.depth + "  node2.depth : " + node2.depth);
        ...
        for (int i = MAX_PARENT_LENGTH - 1; i >= 0 ; i--) {
            if (node1.depth - node2.depth >= power[i]) {
                dist += power[i];
//                System.out.print("  node : " + node1.name + " -> ");
...
//
//        System.out.println("  node1.name : " + node1.name + "  node2.name : " + node2.name);
//        System.out.println("  node1 parent.name : " + node1.parent[13].name + "  node2 parent.name : " + node2.parent[13].name);
//        System.out.println();
...
//                System.out.println("  " + i + " - node1 부모와 node2 부모가 같지 않다.");
//                System.out.println();
            }
        }
