 ...
 */
public class 루돌프의_반란_Test_Print {
...
//            System.out.println();
            ...
            for (int i = 1; i <= P; i++) {
                ...
                if (!santa.isStunned && !santa.isFailed) {
                    moveSanta(santa, t);
//                    testPrint();
                }
            }
...
//        System.out.println("2. " + santa.id + "번 산타 이동");
...
//        System.out.println("1-1. 루돌프의 타겟 산타 : " + targetSanta.id + "\n");
    ...
    static void crash(Santa santa, int dir, int mOption, int turn) {
        if (mOption == M_RUDOLF) {
//            System.out.println("1-2. 루돌프에 의한 충돌 발생");
...
//            System.out.println("1-3. 산타에 의한 충돌 발생");
    ...
    static void testPrint() {
        printBoard();
        printRudolfAndSantaStatus();
    }

    static void printBoard() {
        System.out.println(":: 격자 상태 출력 ::");
        for (int i = 1; i <= N; i++) {
            for (int j = 1; j <= N; j++) {
    ...
    static void printRudolfAndSantaStatus() {
        System.out.println(":: 루돌프 위치 - (" + rudolf.x + ", " + rudolf.y + ") ::");
        System.out.println(":: 산타 상태 :: ");
        for (int i = 1; i <= P; i++) {
            Santa s = santaPool[i];
