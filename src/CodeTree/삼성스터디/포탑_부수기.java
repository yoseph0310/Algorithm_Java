...
public class 포탑_부수기 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // K 번 진행
        for (int k = 1; k <= K; k++) {
//            System.out.println(k + " 번 째 진행");
//            System.out.println();
//
//            System.out.println("1. towerList, tower's relatedAttack, prevPoint 초기화 및 공격자, 타겟 설정");
            initTower();
...
//        System.out.println(" 2-2. 포탄 공격");
    ...
    static void printINFO() {
        printTowerPower();
        printTowerList();
        printAttackerAndTarget();
    }

    static void printTowerPower() {
        System.out.println(":: TowerBoard INFO ::");
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < M; j++) {
                if (towerBoard[i][j] == null) System.out.print(0 + " ");
                else System.out.print(towerBoard[i][j].power + " ");
            }
            System.out.println();
        }
        System.out.println();
    ...
    static void printTowerList() {
        System.out.println(":: TowerList INFO :: ");
    ...
    static void printAttackerAndTarget() {
        System.out.println(":: Attacker & Target INFO ::");
        System.out.println(attack_tower.toString());
        System.out.println(target_tower.toString());
        System.out.println();
    }

    static void printPrevPoint() {
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < M; j++) {
                if (prevPoint[i][j] == null) System.out.print("(x, x)" + " ");
                else System.out.print("(" + prevPoint[i][j].x + ", " + prevPoint[i][j].y + ")" + " ");
            }
            System.out.println();
        }
        System.out.println();
